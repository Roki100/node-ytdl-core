...
exports.getBasicInfo = async(id, options) => {
  ...
  if (options.IPv6Block) {
    options.requestOptions = Object.assign({}, options.requestOptions, {
      family: 6,
      localAddress: util.getRandomIPv6(options.IPv6Block),
    });
  }
  ...
  reqOptions.headers = Object.assign({}, {
    ...
    'x-youtube-client-version': '2.20191008.04.01',//'2.20200701.03.01',
  ...
  if (options.IPv6Block) {
    reqOptions.family = 6,
    reqOptions.localAddress = util.getRandomIPv6(options.IPv6Block)
  }
  ...
  if (!info.player) {
    ...
    if (options.IPv6Block) {
      ...
      options.requestOptions.localAddress = util.getRandomIPv6(options.IPv6Block)
    }
